...
import { Injectable, Inject, PLATFORM_ID, ɵɵdefineInjectable, ɵɵinject, NgZone, RendererFactory2, NgModule } from '@angular/core';
...
import { switchMap, retryWhen, catchError, mergeMap, map, retry, tap, take, timeout, concatMap } from 'rxjs/operators';
...
PlatformProvider.ɵfac = function PlatformProvider_Factory(t) { return new (t || PlatformProvider)(ɵngcc0.ɵɵinject(PLATFORM_ID)); };
PlatformProvider.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: PlatformProvider, factory: PlatformProvider.ɵfac });
PlatformProvider.ctorParameters = () => [
    { type: String, decorators: [{ type: Inject, args: [PLATFORM_ID,] }] }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(PlatformProvider, [{
        type: Injectable
...
ConfigurationProvider.ɵfac = function ConfigurationProvider_Factory(t) { return new (t || ConfigurationProvider)(ɵngcc0.ɵɵinject(PlatformProvider)); };
ConfigurationProvider.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: ConfigurationProvider, factory: ConfigurationProvider.ɵfac });
ConfigurationProvider.ctorParameters = () => [
    { type: PlatformProvider }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(ConfigurationProvider, [{
        type: Injectable
...
HttpBaseService.ɵfac = function HttpBaseService_Factory(t) { return new (t || HttpBaseService)(ɵngcc0.ɵɵinject(ɵngcc1.HttpClient)); };
HttpBaseService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: HttpBaseService, factory: HttpBaseService.ɵfac });
HttpBaseService.ctorParameters = () => [
    { type: HttpClient }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(HttpBaseService, [{
        type: Injectable
...
DataService.ɵfac = function DataService_Factory(t) { return new (t || DataService)(ɵngcc0.ɵɵinject(HttpBaseService), ɵngcc0.ɵɵinject(ConfigurationProvider)); };
...
LoggerService.ɵfac = function LoggerService_Factory(t) { return new (t || LoggerService)(ɵngcc0.ɵɵinject(ConfigurationProvider)); };
...
PublicEventsService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: PublicEventsService, factory: PublicEventsService.ɵfac });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(PublicEventsService, [{
        type: Injectable
...
AbstractSecurityStorage.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: AbstractSecurityStorage, factory: AbstractSecurityStorage.ɵfac });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(AbstractSecurityStorage, [{
        type: Injectable
    }], null, null); })();
...
StoragePersistanceService.ɵfac = function StoragePersistanceService_Factory(t) { return new (t || StoragePersistanceService)(ɵngcc0.ɵɵinject(AbstractSecurityStorage), ɵngcc0.ɵɵinject(ConfigurationProvider)); };
StoragePersistanceService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: StoragePersistanceService, factory: StoragePersistanceService.ɵfac });
StoragePersistanceService.ctorParameters = () => [
    { type: AbstractSecurityStorage },
    { type: ConfigurationProvider }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(StoragePersistanceService, [{
        type: Injectable
...
TokenHelperService.ɵfac = function TokenHelperService_Factory(t) { return new (t || TokenHelperService)(ɵngcc0.ɵɵinject(LoggerService)); };
TokenHelperService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: TokenHelperService, factory: TokenHelperService.ɵfac });
TokenHelperService.ctorParameters = () => [
    { type: LoggerService }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(TokenHelperService, [{
        type: Injectable
...
TokenValidationService.ɵfac = function TokenValidationService_Factory(t) { return new (t || TokenValidationService)(ɵngcc0.ɵɵinject(TokenHelperService), ɵngcc0.ɵɵinject(LoggerService)); };
TokenValidationService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: TokenValidationService, factory: TokenValidationService.ɵfac });
TokenValidationService.refreshTokenNoncePlaceholder = '--RefreshToken--';
TokenValidationService.ctorParameters = () => [
    { type: TokenHelperService },
    { type: LoggerService }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(TokenValidationService, [{
        type: Injectable
...
AuthStateService.ɵfac = function AuthStateService_Factory(t) { return new (t || AuthStateService)(ɵngcc0.ɵɵinject(StoragePersistanceService), ɵngcc0.ɵɵinject(LoggerService), ɵngcc0.ɵɵinject(PublicEventsService), ɵngcc0.ɵɵinject(ConfigurationProvider), ɵngcc0.ɵɵinject(TokenValidationService)); };
AuthStateService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: AuthStateService, factory: AuthStateService.ɵfac });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(AuthStateService, [{
        type: Injectable
...
AutoLoginService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: AutoLoginService, factory: AutoLoginService.ɵfac });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(AutoLoginService, [{
        type: Injectable
    }], null, null); })();
...
RandomService.ɵfac = function RandomService_Factory(t) { return new (t || RandomService)(ɵngcc0.ɵɵinject(DOCUMENT), ɵngcc0.ɵɵinject(LoggerService)); };
RandomService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: RandomService, factory: RandomService.ɵfac });
RandomService.ctorParameters = () => [
    { type: undefined, decorators: [{ type: Inject, args: [DOCUMENT,] }] },
    { type: LoggerService }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(RandomService, [{
        type: Injectable
...
FlowsDataService.ɵfac = function FlowsDataService_Factory(t) { return new (t || FlowsDataService)(ɵngcc0.ɵɵinject(StoragePersistanceService), ɵngcc0.ɵɵinject(RandomService), ɵngcc0.ɵɵinject(ConfigurationProvider), ɵngcc0.ɵɵinject(LoggerService)); };
FlowsDataService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: FlowsDataService, factory: FlowsDataService.ɵfac });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(FlowsDataService, [{
        type: Injectable
...
FlowHelper.ɵfac = function FlowHelper_Factory(t) { return new (t || FlowHelper)(ɵngcc0.ɵɵinject(ConfigurationProvider)); };
FlowHelper.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: FlowHelper, factory: FlowHelper.ɵfac });
FlowHelper.ctorParameters = () => [
    { type: ConfigurationProvider }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(FlowHelper, [{
        type: Injectable
    }], function () { return [{ type: ConfigurationProvider }]; }, null); })();
...
UrlService.ɵfac = function UrlService_Factory(t) { return new (t || UrlService)(ɵngcc0.ɵɵinject(ConfigurationProvider), ɵngcc0.ɵɵinject(LoggerService), ɵngcc0.ɵɵinject(FlowsDataService), ɵngcc0.ɵɵinject(FlowHelper), ɵngcc0.ɵɵinject(TokenValidationService), ɵngcc0.ɵɵinject(StoragePersistanceService)); };
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(UrlService, [{
        type: Injectable
...
CodeFlowCallbackHandlerService.ɵfac = function CodeFlowCallbackHandlerService_Factory(t) { return new (t || CodeFlowCallbackHandlerService)(ɵngcc0.ɵɵinject(UrlService), ɵngcc0.ɵɵinject(LoggerService), ɵngcc0.ɵɵinject(TokenValidationService), ɵngcc0.ɵɵinject(FlowsDataService), ɵngcc0.ɵɵinject(ConfigurationProvider), ɵngcc0.ɵɵinject(StoragePersistanceService), ɵngcc0.ɵɵinject(DataService)); };
CodeFlowCallbackHandlerService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: CodeFlowCallbackHandlerService, factory: CodeFlowCallbackHandlerService.ɵfac });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(CodeFlowCallbackHandlerService, [{
        type: Injectable
    }], function () { return [{ type: UrlService }, { type: LoggerService }, { type: TokenValidationService }, { type: FlowsDataService }, { type: ConfigurationProvider }, { type: StoragePersistanceService }, { type: DataService }]; }, null); })();
...
UserService.ɵfac = function UserService_Factory(t) { return new (t || UserService)(ɵngcc0.ɵɵinject(DataService), ɵngcc0.ɵɵinject(StoragePersistanceService), ɵngcc0.ɵɵinject(PublicEventsService), ɵngcc0.ɵɵinject(LoggerService), ɵngcc0.ɵɵinject(TokenHelperService), ɵngcc0.ɵɵinject(FlowHelper), ɵngcc0.ɵɵinject(ConfigurationProvider)); };
...
ResetAuthDataService.ɵfac = function ResetAuthDataService_Factory(t) { return new (t || ResetAuthDataService)(ɵngcc0.ɵɵinject(AuthStateService), ɵngcc0.ɵɵinject(FlowsDataService), ɵngcc0.ɵɵinject(UserService)); };
ResetAuthDataService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: ResetAuthDataService, factory: ResetAuthDataService.ɵfac });
ResetAuthDataService.ctorParameters = () => [
    { type: AuthStateService },
    { type: FlowsDataService },
    { type: UserService }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(ResetAuthDataService, [{
        type: Injectable
...
SigninKeyDataService.ɵfac = function SigninKeyDataService_Factory(t) { return new (t || SigninKeyDataService)(ɵngcc0.ɵɵinject(StoragePersistanceService), ɵngcc0.ɵɵinject(LoggerService), ɵngcc0.ɵɵinject(DataService)); };
SigninKeyDataService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: SigninKeyDataService, factory: SigninKeyDataService.ɵfac });
SigninKeyDataService.ctorParameters = () => [
    { type: StoragePersistanceService },
    { type: LoggerService },
    { type: DataService }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(SigninKeyDataService, [{
        type: Injectable
...
HistoryJwtKeysCallbackHandlerService.ɵfac = function HistoryJwtKeysCallbackHandlerService_Factory(t) { return new (t || HistoryJwtKeysCallbackHandlerService)(ɵngcc0.ɵɵinject(LoggerService), ɵngcc0.ɵɵinject(ConfigurationProvider), ɵngcc0.ɵɵinject(AuthStateService), ɵngcc0.ɵɵinject(FlowsDataService), ɵngcc0.ɵɵinject(SigninKeyDataService), ɵngcc0.ɵɵinject(StoragePersistanceService), ɵngcc0.ɵɵinject(ResetAuthDataService)); };
HistoryJwtKeysCallbackHandlerService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: HistoryJwtKeysCallbackHandlerService, factory: HistoryJwtKeysCallbackHandlerService.ɵfac });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(HistoryJwtKeysCallbackHandlerService, [{
        type: Injectable
    }], function () { return [{ type: LoggerService }, { type: ConfigurationProvider }, { type: AuthStateService }, { type: FlowsDataService }, { type: SigninKeyDataService }, { type: StoragePersistanceService }, { type: ResetAuthDataService }]; }, null); })();
...
ImplicitFlowCallbackHandlerService.ɵfac = function ImplicitFlowCallbackHandlerService_Factory(t) { return new (t || ImplicitFlowCallbackHandlerService)(ɵngcc0.ɵɵinject(ResetAuthDataService), ɵngcc0.ɵɵinject(LoggerService), ɵngcc0.ɵɵinject(FlowsDataService), ɵngcc0.ɵɵinject(DOCUMENT)); };
ImplicitFlowCallbackHandlerService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: ImplicitFlowCallbackHandlerService, factory: ImplicitFlowCallbackHandlerService.ɵfac });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(ImplicitFlowCallbackHandlerService, [{
        type: Injectable
...
RefreshSessionCallbackHandlerService.ɵfac = function RefreshSessionCallbackHandlerService_Factory(t) { return new (t || RefreshSessionCallbackHandlerService)(ɵngcc0.ɵɵinject(LoggerService), ɵngcc0.ɵɵinject(AuthStateService), ɵngcc0.ɵɵinject(FlowsDataService)); };
RefreshSessionCallbackHandlerService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: RefreshSessionCallbackHandlerService, factory: RefreshSessionCallbackHandlerService.ɵfac });
RefreshSessionCallbackHandlerService.ctorParameters = () => [
    { type: LoggerService },
    { type: AuthStateService },
    { type: FlowsDataService }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(RefreshSessionCallbackHandlerService, [{
        type: Injectable
...
RefreshTokenCallbackHandlerService.ɵfac = function RefreshTokenCallbackHandlerService_Factory(t) { return new (t || RefreshTokenCallbackHandlerService)(ɵngcc0.ɵɵinject(UrlService), ɵngcc0.ɵɵinject(LoggerService), ɵngcc0.ɵɵinject(ConfigurationProvider), ɵngcc0.ɵɵinject(DataService), ɵngcc0.ɵɵinject(StoragePersistanceService)); };
RefreshTokenCallbackHandlerService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: RefreshTokenCallbackHandlerService, factory: RefreshTokenCallbackHandlerService.ɵfac });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(RefreshTokenCallbackHandlerService, [{
        type: Injectable
    }], function () { return [{ type: UrlService }, { type: LoggerService }, { type: ConfigurationProvider }, { type: DataService }, { type: StoragePersistanceService }]; }, null); })();
...
EqualityService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: EqualityService, factory: EqualityService.ɵfac });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(EqualityService, [{
        type: Injectable
    }], null, null); })();
...
StateValidationService.ɵfac = function StateValidationService_Factory(t) { return new (t || StateValidationService)(ɵngcc0.ɵɵinject(StoragePersistanceService), ɵngcc0.ɵɵinject(TokenValidationService), ɵngcc0.ɵɵinject(TokenHelperService), ɵngcc0.ɵɵinject(LoggerService), ɵngcc0.ɵɵinject(ConfigurationProvider), ɵngcc0.ɵɵinject(EqualityService), ɵngcc0.ɵɵinject(FlowHelper)); };
StateValidationService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: StateValidationService, factory: StateValidationService.ɵfac });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(StateValidationService, [{
        type: Injectable
...
StateValidationCallbackHandlerService.ɵfac = function StateValidationCallbackHandlerService_Factory(t) { return new (t || StateValidationCallbackHandlerService)(ɵngcc0.ɵɵinject(LoggerService), ɵngcc0.ɵɵinject(StateValidationService), ɵngcc0.ɵɵinject(AuthStateService), ɵngcc0.ɵɵinject(ResetAuthDataService), ɵngcc0.ɵɵinject(DOCUMENT)); };
StateValidationCallbackHandlerService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: StateValidationCallbackHandlerService, factory: StateValidationCallbackHandlerService.ɵfac });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(StateValidationCallbackHandlerService, [{
        type: Injectable
...
UserCallbackHandlerService.ɵfac = function UserCallbackHandlerService_Factory(t) { return new (t || UserCallbackHandlerService)(ɵngcc0.ɵɵinject(LoggerService), ɵngcc0.ɵɵinject(ConfigurationProvider), ɵngcc0.ɵɵinject(AuthStateService), ɵngcc0.ɵɵinject(FlowsDataService), ɵngcc0.ɵɵinject(UserService), ɵngcc0.ɵɵinject(ResetAuthDataService)); };
UserCallbackHandlerService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: UserCallbackHandlerService, factory: UserCallbackHandlerService.ɵfac });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(UserCallbackHandlerService, [{
        type: Injectable
...
FlowsService.ɵfac = function FlowsService_Factory(t) { return new (t || FlowsService)(ɵngcc0.ɵɵinject(CodeFlowCallbackHandlerService), ɵngcc0.ɵɵinject(ImplicitFlowCallbackHandlerService), ɵngcc0.ɵɵinject(HistoryJwtKeysCallbackHandlerService), ɵngcc0.ɵɵinject(UserCallbackHandlerService), ɵngcc0.ɵɵinject(StateValidationCallbackHandlerService), ɵngcc0.ɵɵinject(RefreshSessionCallbackHandlerService), ɵngcc0.ɵɵinject(RefreshTokenCallbackHandlerService)); };
FlowsService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: FlowsService, factory: FlowsService.ɵfac });
...
IntervallService.ɵfac = function IntervallService_Factory(t) { return new (t || IntervallService)(ɵngcc0.ɵɵinject(ɵngcc0.NgZone)); };
IntervallService.ɵprov = ɵɵdefineInjectable({ factory: function IntervallService_Factory() { return new IntervallService(ɵɵinject(NgZone)); }, token: IntervallService, providedIn: "root" });
IntervallService.ctorParameters = () => [
    { type: NgZone }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(IntervallService, [{
        type: Injectable,
...
ImplicitFlowCallbackService.ɵfac = function ImplicitFlowCallbackService_Factory(t) { return new (t || ImplicitFlowCallbackService)(ɵngcc0.ɵɵinject(FlowsService), ɵngcc0.ɵɵinject(ConfigurationProvider), ɵngcc0.ɵɵinject(ɵngcc2.Router), ɵngcc0.ɵɵinject(FlowsDataService), ɵngcc0.ɵɵinject(IntervallService)); };
ImplicitFlowCallbackService.ɵprov = ɵɵdefineInjectable({ factory: function ImplicitFlowCallbackService_Factory() { return new ImplicitFlowCallbackService(ɵɵinject(FlowsService), ɵɵinject(ConfigurationProvider), ɵɵinject(Router), ɵɵinject(FlowsDataService), ɵɵinject(IntervallService)); }, token: ImplicitFlowCallbackService, providedIn: "root" });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(ImplicitFlowCallbackService, [{
        type: Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: FlowsService }, { type: ConfigurationProvider }, { type: ɵngcc2.Router }, { type: FlowsDataService }, { type: IntervallService }]; }, null); })();
...
CodeFlowCallbackService.ɵfac = function CodeFlowCallbackService_Factory(t) { return new (t || CodeFlowCallbackService)(ɵngcc0.ɵɵinject(FlowsService), ɵngcc0.ɵɵinject(FlowsDataService), ɵngcc0.ɵɵinject(IntervallService), ɵngcc0.ɵɵinject(ConfigurationProvider), ɵngcc0.ɵɵinject(ɵngcc2.Router)); };
CodeFlowCallbackService.ɵprov = ɵɵdefineInjectable({ factory: function CodeFlowCallbackService_Factory() { return new CodeFlowCallbackService(ɵɵinject(FlowsService), ɵɵinject(FlowsDataService), ɵɵinject(IntervallService), ɵɵinject(ConfigurationProvider), ɵɵinject(Router)); }, token: CodeFlowCallbackService, providedIn: "root" });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(CodeFlowCallbackService, [{
        type: Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: FlowsService }, { type: FlowsDataService }, { type: IntervallService }, { type: ConfigurationProvider }, { type: ɵngcc2.Router }]; }, null); })();
...
CallbackService.ɵfac = function CallbackService_Factory(t) { return new (t || CallbackService)(ɵngcc0.ɵɵinject(UrlService), ɵngcc0.ɵɵinject(FlowHelper), ɵngcc0.ɵɵinject(ImplicitFlowCallbackService), ɵngcc0.ɵɵinject(CodeFlowCallbackService)); };
CallbackService.ɵprov = ɵɵdefineInjectable({ factory: function CallbackService_Factory() { return new CallbackService(ɵɵinject(UrlService), ɵɵinject(FlowHelper), ɵɵinject(ImplicitFlowCallbackService), ɵɵinject(CodeFlowCallbackService)); }, token: CallbackService, providedIn: "root" });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(CallbackService, [{
        type: Injectable,
        args: [{ providedIn: 'root' }]
...
IFrameService.ɵfac = function IFrameService_Factory(t) { return new (t || IFrameService)(ɵngcc0.ɵɵinject(DOCUMENT), ɵngcc0.ɵɵinject(LoggerService)); };
IFrameService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: IFrameService, factory: IFrameService.ɵfac });
IFrameService.ctorParameters = () => [
    { type: undefined, decorators: [{ type: Inject, args: [DOCUMENT,] }] },
    { type: LoggerService }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(IFrameService, [{
        type: Injectable
    }], function () { return [{ type: undefined, decorators: [{
                type: Inject,
                args: [DOCUMENT]
...
SilentRenewService.ɵfac = function SilentRenewService_Factory(t) { return new (t || SilentRenewService)(ɵngcc0.ɵɵinject(ConfigurationProvider), ɵngcc0.ɵɵinject(IFrameService), ɵngcc0.ɵɵinject(FlowsService), ɵngcc0.ɵɵinject(ResetAuthDataService), ɵngcc0.ɵɵinject(FlowsDataService), ɵngcc0.ɵɵinject(AuthStateService), ɵngcc0.ɵɵinject(LoggerService), ɵngcc0.ɵɵinject(FlowHelper), ɵngcc0.ɵɵinject(ImplicitFlowCallbackService), ɵngcc0.ɵɵinject(IntervallService)); };
SilentRenewService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: SilentRenewService, factory: SilentRenewService.ɵfac });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(SilentRenewService, [{
        type: Injectable
...
RefreshSessionIframeService.ɵfac = function RefreshSessionIframeService_Factory(t) { return new (t || RefreshSessionIframeService)(ɵngcc0.ɵɵinject(DOCUMENT), ɵngcc0.ɵɵinject(LoggerService), ɵngcc0.ɵɵinject(UrlService), ɵngcc0.ɵɵinject(SilentRenewService), ɵngcc0.ɵɵinject(ɵngcc0.RendererFactory2)); };
RefreshSessionIframeService.ɵprov = ɵɵdefineInjectable({ factory: function RefreshSessionIframeService_Factory() { return new RefreshSessionIframeService(ɵɵinject(DOCUMENT), ɵɵinject(LoggerService), ɵɵinject(UrlService), ɵɵinject(SilentRenewService), ɵɵinject(RendererFactory2)); }, token: RefreshSessionIframeService, providedIn: "root" });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(RefreshSessionIframeService, [{
        type: Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: undefined, decorators: [{
                type: Inject,
                args: [DOCUMENT]
            }] }, { type: LoggerService }, { type: UrlService }, { type: SilentRenewService }, { type: ɵngcc0.RendererFactory2 }]; }, null); })();
...
RefreshSessionRefreshTokenService.ɵfac = function RefreshSessionRefreshTokenService_Factory(t) { return new (t || RefreshSessionRefreshTokenService)(ɵngcc0.ɵɵinject(LoggerService), ɵngcc0.ɵɵinject(ResetAuthDataService), ɵngcc0.ɵɵinject(FlowsService), ɵngcc0.ɵɵinject(IntervallService)); };
RefreshSessionRefreshTokenService.ɵprov = ɵɵdefineInjectable({ factory: function RefreshSessionRefreshTokenService_Factory() { return new RefreshSessionRefreshTokenService(ɵɵinject(LoggerService), ɵɵinject(ResetAuthDataService), ɵɵinject(FlowsService), ɵɵinject(IntervallService)); }, token: RefreshSessionRefreshTokenService, providedIn: "root" });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(RefreshSessionRefreshTokenService, [{
        type: Injectable,
        args: [{ providedIn: 'root' }]
...
PeriodicallyTokenCheckService.ɵfac = function PeriodicallyTokenCheckService_Factory(t) { return new (t || PeriodicallyTokenCheckService)(ɵngcc0.ɵɵinject(ResetAuthDataService), ɵngcc0.ɵɵinject(FlowHelper), ɵngcc0.ɵɵinject(ConfigurationProvider), ɵngcc0.ɵɵinject(FlowsDataService), ɵngcc0.ɵɵinject(LoggerService), ɵngcc0.ɵɵinject(UserService), ɵngcc0.ɵɵinject(AuthStateService), ɵngcc0.ɵɵinject(RefreshSessionIframeService), ɵngcc0.ɵɵinject(RefreshSessionRefreshTokenService), ɵngcc0.ɵɵinject(IntervallService), ɵngcc0.ɵɵinject(StoragePersistanceService)); };
PeriodicallyTokenCheckService.ɵprov = ɵɵdefineInjectable({ factory: function PeriodicallyTokenCheckService_Factory() { return new PeriodicallyTokenCheckService(ɵɵinject(ResetAuthDataService), ɵɵinject(FlowHelper), ɵɵinject(ConfigurationProvider), ɵɵinject(FlowsDataService), ɵɵinject(LoggerService), ɵɵinject(UserService), ɵɵinject(AuthStateService), ɵɵinject(RefreshSessionIframeService), ɵɵinject(RefreshSessionRefreshTokenService), ɵɵinject(IntervallService), ɵɵinject(StoragePersistanceService)); }, token: PeriodicallyTokenCheckService, providedIn: "root" });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(PeriodicallyTokenCheckService, [{
        type: Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: ResetAuthDataService }, { type: FlowHelper }, { type: ConfigurationProvider }, { type: FlowsDataService }, { type: LoggerService }, { type: UserService }, { type: AuthStateService }, { type: RefreshSessionIframeService }, { type: RefreshSessionRefreshTokenService }, { type: IntervallService }, { type: StoragePersistanceService }]; }, null); })();
...
AuthWellKnownDataService.ɵfac = function AuthWellKnownDataService_Factory(t) { return new (t || AuthWellKnownDataService)(ɵngcc0.ɵɵinject(DataService)); };
AuthWellKnownDataService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: AuthWellKnownDataService, factory: AuthWellKnownDataService.ɵfac });
AuthWellKnownDataService.ctorParameters = () => [
    { type: DataService }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(AuthWellKnownDataService, [{
        type: Injectable
...
AuthWellKnownService.ɵfac = function AuthWellKnownService_Factory(t) { return new (t || AuthWellKnownService)(ɵngcc0.ɵɵinject(PublicEventsService), ɵngcc0.ɵɵinject(AuthWellKnownDataService), ɵngcc0.ɵɵinject(StoragePersistanceService)); };
AuthWellKnownService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: AuthWellKnownService, factory: AuthWellKnownService.ɵfac });
AuthWellKnownService.ctorParameters = () => [
    { type: PublicEventsService },
    { type: AuthWellKnownDataService },
    { type: StoragePersistanceService }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(AuthWellKnownService, [{
        type: Injectable
...
RefreshSessionService.ɵfac = function RefreshSessionService_Factory(t) { return new (t || RefreshSessionService)(ɵngcc0.ɵɵinject(FlowHelper), ɵngcc0.ɵɵinject(ConfigurationProvider), ɵngcc0.ɵɵinject(FlowsDataService), ɵngcc0.ɵɵinject(LoggerService), ɵngcc0.ɵɵinject(SilentRenewService), ɵngcc0.ɵɵinject(AuthStateService), ɵngcc0.ɵɵinject(AuthWellKnownService), ɵngcc0.ɵɵinject(RefreshSessionIframeService), ɵngcc0.ɵɵinject(RefreshSessionRefreshTokenService)); };
RefreshSessionService.ɵprov = ɵɵdefineInjectable({ factory: function RefreshSessionService_Factory() { return new RefreshSessionService(ɵɵinject(FlowHelper), ɵɵinject(ConfigurationProvider), ɵɵinject(FlowsDataService), ɵɵinject(LoggerService), ɵɵinject(SilentRenewService), ɵɵinject(AuthStateService), ɵɵinject(AuthWellKnownService), ɵɵinject(RefreshSessionIframeService), ɵɵinject(RefreshSessionRefreshTokenService)); }, token: RefreshSessionService, providedIn: "root" });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(RefreshSessionService, [{
        type: Injectable,
        args: [{ providedIn: 'root' }]
...
CheckSessionService.ɵfac = function CheckSessionService_Factory(t) { return new (t || CheckSessionService)(ɵngcc0.ɵɵinject(StoragePersistanceService), ɵngcc0.ɵɵinject(LoggerService), ɵngcc0.ɵɵinject(IFrameService), ɵngcc0.ɵɵinject(PublicEventsService), ɵngcc0.ɵɵinject(ConfigurationProvider), ɵngcc0.ɵɵinject(ɵngcc0.NgZone)); };
CheckSessionService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: CheckSessionService, factory: CheckSessionService.ɵfac });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(CheckSessionService, [{
        type: Injectable
    }], function () { return [{ type: StoragePersistanceService }, { type: LoggerService }, { type: IFrameService }, { type: PublicEventsService }, { type: ConfigurationProvider }, { type: ɵngcc0.NgZone }]; }, null); })();
...
CheckAuthService.ɵfac = function CheckAuthService_Factory(t) { return new (t || CheckAuthService)(ɵngcc0.ɵɵinject(DOCUMENT), ɵngcc0.ɵɵinject(CheckSessionService), ɵngcc0.ɵɵinject(SilentRenewService), ɵngcc0.ɵɵinject(UserService), ɵngcc0.ɵɵinject(LoggerService), ɵngcc0.ɵɵinject(ConfigurationProvider), ɵngcc0.ɵɵinject(AuthStateService), ɵngcc0.ɵɵinject(CallbackService), ɵngcc0.ɵɵinject(RefreshSessionService), ɵngcc0.ɵɵinject(PeriodicallyTokenCheckService), ɵngcc0.ɵɵinject(PopUpService), ɵngcc0.ɵɵinject(AutoLoginService), ɵngcc0.ɵɵinject(ɵngcc2.Router)); };
CheckAuthService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: CheckAuthService, factory: CheckAuthService.ɵfac });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(CheckAuthService, [{
        type: Injectable
    }], function () { return [{ type: undefined, decorators: [{
                type: Inject,
                args: [DOCUMENT]
            }] }, { type: CheckSessionService }, { type: SilentRenewService }, { type: UserService }, { type: LoggerService }, { type: ConfigurationProvider }, { type: AuthStateService }, { type: CallbackService }, { type: RefreshSessionService }, { type: PeriodicallyTokenCheckService }, { type: PopUpService }, { type: AutoLoginService }, { type: ɵngcc2.Router }]; }, null); })();
...
ConfigValidationService.ɵfac = function ConfigValidationService_Factory(t) { return new (t || ConfigValidationService)(ɵngcc0.ɵɵinject(LoggerService)); };
ConfigValidationService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: ConfigValidationService, factory: ConfigValidationService.ɵfac });
ConfigValidationService.ctorParameters = () => [
    { type: LoggerService }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(ConfigValidationService, [{
        type: Injectable
    }], function () { return [{ type: LoggerService }]; }, null); })();
...
OidcConfigService.ɵfac = function OidcConfigService_Factory(t) { return new (t || OidcConfigService)(ɵngcc0.ɵɵinject(LoggerService), ɵngcc0.ɵɵinject(PublicEventsService), ɵngcc0.ɵɵinject(ConfigurationProvider), ɵngcc0.ɵɵinject(AuthWellKnownService), ɵngcc0.ɵɵinject(StoragePersistanceService), ɵngcc0.ɵɵinject(ConfigValidationService)); };
OidcConfigService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: OidcConfigService, factory: OidcConfigService.ɵfac });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(OidcConfigService, [{
        type: Injectable
...
RedirectService.ɵfac = function RedirectService_Factory(t) { return new (t || RedirectService)(ɵngcc0.ɵɵinject(DOCUMENT)); };
RedirectService.ɵprov = ɵɵdefineInjectable({ factory: function RedirectService_Factory() { return new RedirectService(ɵɵinject(DOCUMENT)); }, token: RedirectService, providedIn: "root" });
RedirectService.ctorParameters = () => [
    { type: undefined, decorators: [{ type: Inject, args: [DOCUMENT,] }] }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(RedirectService, [{
        type: Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: undefined, decorators: [{
                type: Inject,
...
ResponseTypeValidationService.ɵfac = function ResponseTypeValidationService_Factory(t) { return new (t || ResponseTypeValidationService)(ɵngcc0.ɵɵinject(LoggerService), ɵngcc0.ɵɵinject(FlowHelper)); };
ResponseTypeValidationService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: ResponseTypeValidationService, factory: ResponseTypeValidationService.ɵfac });
ResponseTypeValidationService.ctorParameters = () => [
    { type: LoggerService },
    { type: FlowHelper }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(ResponseTypeValidationService, [{
        type: Injectable
...
ParService.ɵfac = function ParService_Factory(t) { return new (t || ParService)(ɵngcc0.ɵɵinject(LoggerService), ɵngcc0.ɵɵinject(UrlService), ɵngcc0.ɵɵinject(DataService), ɵngcc0.ɵɵinject(StoragePersistanceService)); };
ParService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: ParService, factory: ParService.ɵfac });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(ParService, [{
        type: Injectable
    }], function () { return [{ type: LoggerService }, { type: UrlService }, { type: DataService }, { type: StoragePersistanceService }]; }, null); })();
...
ParLoginService.ɵfac = function ParLoginService_Factory(t) { return new (t || ParLoginService)(ɵngcc0.ɵɵinject(LoggerService), ɵngcc0.ɵɵinject(ResponseTypeValidationService), ɵngcc0.ɵɵinject(UrlService), ɵngcc0.ɵɵinject(RedirectService), ɵngcc0.ɵɵinject(ConfigurationProvider), ɵngcc0.ɵɵinject(AuthWellKnownService), ɵngcc0.ɵɵinject(PopUpService), ɵngcc0.ɵɵinject(CheckAuthService), ɵngcc0.ɵɵinject(UserService), ɵngcc0.ɵɵinject(AuthStateService), ɵngcc0.ɵɵinject(ParService)); };
ParLoginService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: ParLoginService, factory: ParLoginService.ɵfac });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(ParLoginService, [{
        type: Injectable
...
PopUpLoginService.ɵfac = function PopUpLoginService_Factory(t) { return new (t || PopUpLoginService)(ɵngcc0.ɵɵinject(LoggerService), ɵngcc0.ɵɵinject(ResponseTypeValidationService), ɵngcc0.ɵɵinject(UrlService), ɵngcc0.ɵɵinject(ConfigurationProvider), ɵngcc0.ɵɵinject(AuthWellKnownService), ɵngcc0.ɵɵinject(PopUpService), ɵngcc0.ɵɵinject(CheckAuthService), ɵngcc0.ɵɵinject(UserService), ɵngcc0.ɵɵinject(AuthStateService)); };
PopUpLoginService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: PopUpLoginService, factory: PopUpLoginService.ɵfac });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(PopUpLoginService, [{
        type: Injectable
...
StandardLoginService.ɵfac = function StandardLoginService_Factory(t) { return new (t || StandardLoginService)(ɵngcc0.ɵɵinject(LoggerService), ɵngcc0.ɵɵinject(ResponseTypeValidationService), ɵngcc0.ɵɵinject(UrlService), ɵngcc0.ɵɵinject(RedirectService), ɵngcc0.ɵɵinject(ConfigurationProvider), ɵngcc0.ɵɵinject(AuthWellKnownService)); };
StandardLoginService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: StandardLoginService, factory: StandardLoginService.ɵfac });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(StandardLoginService, [{
        type: Injectable
...
LoginService.ɵfac = function LoginService_Factory(t) { return new (t || LoginService)(ɵngcc0.ɵɵinject(ConfigurationProvider), ɵngcc0.ɵɵinject(ParLoginService), ɵngcc0.ɵɵinject(PopUpLoginService), ɵngcc0.ɵɵinject(StandardLoginService)); };
...
LogoffRevocationService.ɵfac = function LogoffRevocationService_Factory(t) { return new (t || LogoffRevocationService)(ɵngcc0.ɵɵinject(DataService), ɵngcc0.ɵɵinject(StoragePersistanceService), ɵngcc0.ɵɵinject(LoggerService), ɵngcc0.ɵɵinject(UrlService), ɵngcc0.ɵɵinject(CheckSessionService), ɵngcc0.ɵɵinject(ResetAuthDataService), ɵngcc0.ɵɵinject(RedirectService)); };
LogoffRevocationService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: LogoffRevocationService, factory: LogoffRevocationService.ɵfac });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(LogoffRevocationService, [{
        type: Injectable
    }], function () { return [{ type: DataService }, { type: StoragePersistanceService }, { type: LoggerService }, { type: UrlService }, { type: CheckSessionService }, { type: ResetAuthDataService }, { type: RedirectService }]; }, null); })();
...
OidcSecurityService.ɵfac = function OidcSecurityService_Factory(t) { return new (t || OidcSecurityService)(ɵngcc0.ɵɵinject(CheckSessionService), ɵngcc0.ɵɵinject(CheckAuthService), ɵngcc0.ɵɵinject(UserService), ɵngcc0.ɵɵinject(TokenHelperService), ɵngcc0.ɵɵinject(ConfigurationProvider), ɵngcc0.ɵɵinject(AuthStateService), ɵngcc0.ɵɵinject(FlowsDataService), ɵngcc0.ɵɵinject(CallbackService), ɵngcc0.ɵɵinject(LogoffRevocationService), ɵngcc0.ɵɵinject(LoginService), ɵngcc0.ɵɵinject(StoragePersistanceService), ɵngcc0.ɵɵinject(RefreshSessionService)); };
OidcSecurityService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: OidcSecurityService, factory: OidcSecurityService.ɵfac });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(OidcSecurityService, [{
        type: Injectable
...
BrowserStorageService.ɵfac = function BrowserStorageService_Factory(t) { return new (t || BrowserStorageService)(ɵngcc0.ɵɵinject(ConfigurationProvider), ɵngcc0.ɵɵinject(LoggerService)); };
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(BrowserStorageService, [{
        type: Injectable
...
AuthModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ imports: [[CommonModule, HttpClientModule]] });
...
AutoLoginGuard.ɵfac = function AutoLoginGuard_Factory(t) { return new (t || AutoLoginGuard)(ɵngcc0.ɵɵinject(AutoLoginService), ɵngcc0.ɵɵinject(AuthStateService), ɵngcc0.ɵɵinject(CheckAuthService), ɵngcc0.ɵɵinject(LoginService), ɵngcc0.ɵɵinject(ɵngcc2.Router)); };
AutoLoginGuard.ɵprov = ɵɵdefineInjectable({ factory: function AutoLoginGuard_Factory() { return new AutoLoginGuard(ɵɵinject(AutoLoginService), ɵɵinject(AuthStateService), ɵɵinject(CheckAuthService), ɵɵinject(LoginService), ɵɵinject(Router)); }, token: AutoLoginGuard, providedIn: "root" });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(AutoLoginGuard, [{
        type: Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: AutoLoginService }, { type: AuthStateService }, { type: CheckAuthService }, { type: LoginService }, { type: ɵngcc2.Router }]; }, null); })();
...
AuthInterceptor.ɵfac = function AuthInterceptor_Factory(t) { return new (t || AuthInterceptor)(ɵngcc0.ɵɵinject(AuthStateService), ɵngcc0.ɵɵinject(ConfigurationProvider), ɵngcc0.ɵɵinject(LoggerService)); };
...
export { AbstractSecurityStorage, AuthInterceptor, AuthModule, AuthorizedState, AutoLoginGuard, EventTypes, LogLevel, LoggerService, OidcConfigService, OidcSecurityService, PublicEventsService, StateValidationResult, TokenHelperService, TokenValidationService, ValidationResult, ConfigurationProvider as ɵa, PlatformProvider as ɵb, StateValidationService as ɵba, EqualityService as ɵbb, RefreshSessionCallbackHandlerService as ɵbc, RefreshTokenCallbackHandlerService as ɵbd, ImplicitFlowCallbackService as ɵbe, IntervallService as ɵbf, CallbackService as ɵbg, CodeFlowCallbackService as ɵbh, RefreshSessionService as ɵbi, RefreshSessionIframeService as ɵbj, RefreshSessionRefreshTokenService as ɵbk, PeriodicallyTokenCheckService as ɵbl, PopUpService as ɵbm, AutoLoginService as ɵbn, LogoffRevocationService as ɵbo, RedirectService as ɵbp, LoginService as ɵbq, ParLoginService as ɵbr, ResponseTypeValidationService as ɵbs, ParService as ɵbt, PopUpLoginService as ɵbu, StandardLoginService as ɵbv, BrowserStorageService as ɵbw, AuthWellKnownService as ɵc, AuthWellKnownDataService as ɵd, DataService as ɵe, HttpBaseService as ɵf, StoragePersistanceService as ɵg, ConfigValidationService as ɵh, FlowHelper as ɵi, CheckSessionService as ɵj, IFrameService as ɵk, CheckAuthService as ɵl, SilentRenewService as ɵm, FlowsService as ɵn, CodeFlowCallbackHandlerService as ɵo, UrlService as ɵp, FlowsDataService as ɵq, RandomService as ɵr, ImplicitFlowCallbackHandlerService as ɵs, ResetAuthDataService as ɵt, AuthStateService as ɵu, UserService as ɵv, HistoryJwtKeysCallbackHandlerService as ɵw, SigninKeyDataService as ɵx, UserCallbackHandlerService as ɵy, StateValidationCallbackHandlerService as ɵz };
