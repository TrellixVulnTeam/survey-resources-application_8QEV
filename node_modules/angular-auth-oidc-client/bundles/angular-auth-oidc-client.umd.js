(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/common/http'), require('@angular/core'), require('rxjs'), require('jsrsasign-reduced'), require('@angular/router'), require('rxjs/operators'), require('common-tags')) :
    typeof define === 'function' && define.amd ? define('angular-auth-oidc-client', ['exports', '@angular/common', '@angular/common/http', '@angular/core', 'rxjs', 'jsrsasign-reduced', '@angular/router', 'rxjs/operators', 'common-tags'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['angular-auth-oidc-client'] = {}, global.ng.common, global.ng.common.http, global.ng.core, global.rxjs, global['jsrsasign-reduced'], global.ng.router, global.rxjs.operators, global['common-tags']));
}(this, (function (exports, i1, http, i0, rxjs, jsrsasignReduced, i5, operators, commonTags) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    PublicEventsService.decorators = [
        { type: i0.Injectable }
    ];
    ...
    AbstractSecurityStorage.decorators = [
        { type: i0.Injectable }
    ];
    ...
    var FlowsDataService = /** @class */ (function () {
        ...
        FlowsDataService.prototype.isSilentRenewRunning = function () {
            var storageObject = JSON.parse(this.storagePersistanceService.read('storageSilentRenewRunning'));
            if (storageObject) {
    ...
    var CodeFlowCallbackHandlerService = /** @class */ (function () {
        function CodeFlowCallbackHandlerService(urlService, loggerService, tokenValidationService, flowsDataService, configurationProvider, storagePersistanceService, dataService) {
        ...
        CodeFlowCallbackHandlerService.prototype.handleRefreshRetry = function (errors) {
            ...
            return errors.pipe(operators.mergeMap(function (error) {
                ...
                if (error && error instanceof http.HttpErrorResponse && error.error instanceof ProgressEvent && error.error.type === 'error') {
    ...
    CodeFlowCallbackHandlerService.ctorParameters = function () { return [
        { type: UrlService },
        { type: LoggerService },
        { type: TokenValidationService },
        { type: FlowsDataService },
    ...
    ResetAuthDataService.decorators = [
        { type: i0.Injectable }
    ];
    ResetAuthDataService.ctorParameters = function () { return [
    ...
    var SigninKeyDataService = /** @class */ (function () {
        ...
        SigninKeyDataService.prototype.handleErrorGetSigningKeys = function (errorResponse) {
            var errMsg = '';
            if (errorResponse instanceof http.HttpResponse) {
    ...
    SigninKeyDataService.decorators = [
        { type: i0.Injectable }
    ];
    ...
    var HistoryJwtKeysCallbackHandlerService = /** @class */ (function () {
        function HistoryJwtKeysCallbackHandlerService(loggerService, configurationProvider, authStateService, flowsDataService, signInKeyDataService, storagePersistanceService, resetAuthDataService) {
            this.loggerService = loggerService;
            this.configurationProvider = configurationProvider;
            this.authStateService = authStateService;
            this.flowsDataService = flowsDataService;
    ...
    HistoryJwtKeysCallbackHandlerService.ctorParameters = function () { return [
        { type: LoggerService },
        { type: ConfigurationProvider },
        { type: AuthStateService },
        { type: FlowsDataService },
    ...
    ImplicitFlowCallbackHandlerService.ctorParameters = function () { return [
        { type: ResetAuthDataService },
        { type: LoggerService },
        { type: FlowsDataService },
        { type: undefined, decorators: [{ type: i0.Inject, args: [i1.DOCUMENT,] }] }
    ...
    RefreshSessionCallbackHandlerService.ctorParameters = function () { return [
        { type: LoggerService },
        { type: AuthStateService },
        { type: FlowsDataService }
    ]; };
    ...
    var RefreshTokenCallbackHandlerService = /** @class */ (function () {
        function RefreshTokenCallbackHandlerService(urlService, loggerService, configurationProvider, dataService, storagePersistanceService) {
            this.urlService = urlService;
            this.loggerService = loggerService;
            this.configurationProvider = configurationProvider;
            this.dataService = dataService;
        ...
        RefreshTokenCallbackHandlerService.prototype.refreshTokensRequestTokens = function (callbackContext, customParams) {
            var _this = this;
            var headers = new http.HttpHeaders();
            headers = headers.set('Content-Type', 'application/x-www-form-urlencoded');
            var authWellKnown = this.storagePersistanceService.read('authWellKnownEndPoints');
    ...
    RefreshTokenCallbackHandlerService.ctorParameters = function () { return [
        { type: UrlService },
        { type: LoggerService },
        { type: ConfigurationProvider },
        { type: DataService },
    ...
    StateValidationCallbackHandlerService.ctorParameters = function () { return [
        { type: LoggerService },
    ...
    UserCallbackHandlerService.ctorParameters = function () { return [
        { type: LoggerService },
        { type: ConfigurationProvider },
        { type: AuthStateService },
        { type: FlowsDataService },
    ...
    IntervallService.ctorParameters = function () { return [
        { type: i0.NgZone }
    ]; };
    ...
    ImplicitFlowCallbackService.ɵprov = i0.ɵɵdefineInjectable({ factory: function ImplicitFlowCallbackService_Factory() { return new ImplicitFlowCallbackService(i0.ɵɵinject(FlowsService), i0.ɵɵinject(ConfigurationProvider), i0.ɵɵinject(i5.Router), i0.ɵɵinject(FlowsDataService), i0.ɵɵinject(IntervallService)); }, token: ImplicitFlowCallbackService, providedIn: "root" });
    ImplicitFlowCallbackService.decorators = [
        { type: i0.Injectable, args: [{ providedIn: 'root' },] }
    ];
    ImplicitFlowCallbackService.ctorParameters = function () { return [
        { type: FlowsService },
        { type: ConfigurationProvider },
        { type: i5.Router },
        { type: FlowsDataService },
    ...
    CodeFlowCallbackService.ɵprov = i0.ɵɵdefineInjectable({ factory: function CodeFlowCallbackService_Factory() { return new CodeFlowCallbackService(i0.ɵɵinject(FlowsService), i0.ɵɵinject(FlowsDataService), i0.ɵɵinject(IntervallService), i0.ɵɵinject(ConfigurationProvider), i0.ɵɵinject(i5.Router)); }, token: CodeFlowCallbackService, providedIn: "root" });
    CodeFlowCallbackService.decorators = [
        { type: i0.Injectable, args: [{ providedIn: 'root' },] }
    ];
    CodeFlowCallbackService.ctorParameters = function () { return [
        { type: FlowsService },
        { type: FlowsDataService },
        { type: IntervallService },
        { type: ConfigurationProvider },
    ...
    CallbackService.ɵprov = i0.ɵɵdefineInjectable({ factory: function CallbackService_Factory() { return new CallbackService(i0.ɵɵinject(UrlService), i0.ɵɵinject(FlowHelper), i0.ɵɵinject(ImplicitFlowCallbackService), i0.ɵɵinject(CodeFlowCallbackService)); }, token: CallbackService, providedIn: "root" });
    ...
    RefreshSessionIframeService.ɵprov = i0.ɵɵdefineInjectable({ factory: function RefreshSessionIframeService_Factory() { return new RefreshSessionIframeService(i0.ɵɵinject(i1.DOCUMENT), i0.ɵɵinject(LoggerService), i0.ɵɵinject(UrlService), i0.ɵɵinject(SilentRenewService), i0.ɵɵinject(i0.RendererFactory2)); }, token: RefreshSessionIframeService, providedIn: "root" });
    RefreshSessionIframeService.decorators = [
        { type: i0.Injectable, args: [{ providedIn: 'root' },] }
    ];
    RefreshSessionIframeService.ctorParameters = function () { return [
        { type: undefined, decorators: [{ type: i0.Inject, args: [i1.DOCUMENT,] }] },
        { type: LoggerService },
        { type: UrlService },
    ...
    RefreshSessionRefreshTokenService.ɵprov = i0.ɵɵdefineInjectable({ factory: function RefreshSessionRefreshTokenService_Factory() { return new RefreshSessionRefreshTokenService(i0.ɵɵinject(LoggerService), i0.ɵɵinject(ResetAuthDataService), i0.ɵɵinject(FlowsService), i0.ɵɵinject(IntervallService)); }, token: RefreshSessionRefreshTokenService, providedIn: "root" });
    RefreshSessionRefreshTokenService.decorators = [
        { type: i0.Injectable, args: [{ providedIn: 'root' },] }
    ];
    RefreshSessionRefreshTokenService.ctorParameters = function () { return [
        { type: LoggerService },
        { type: ResetAuthDataService },
        { type: FlowsService },
        { type: IntervallService }
    ...
    var PeriodicallyTokenCheckService = /** @class */ (function () {
        function PeriodicallyTokenCheckService(resetAuthDataService, flowHelper, configurationProvider, flowsDataService, loggerService, userService, authStateService, refreshSessionIframeService, refreshSessionRefreshTokenService, intervalService, storagePersistanceService) {
            this.resetAuthDataService = resetAuthDataService;
            this.flowHelper = flowHelper;
            this.configurationProvider = configurationProvider;
            this.flowsDataService = flowsDataService;
    ...
    PeriodicallyTokenCheckService.ɵprov = i0.ɵɵdefineInjectable({ factory: function PeriodicallyTokenCheckService_Factory() { return new PeriodicallyTokenCheckService(i0.ɵɵinject(ResetAuthDataService), i0.ɵɵinject(FlowHelper), i0.ɵɵinject(ConfigurationProvider), i0.ɵɵinject(FlowsDataService), i0.ɵɵinject(LoggerService), i0.ɵɵinject(UserService), i0.ɵɵinject(AuthStateService), i0.ɵɵinject(RefreshSessionIframeService), i0.ɵɵinject(RefreshSessionRefreshTokenService), i0.ɵɵinject(IntervallService), i0.ɵɵinject(StoragePersistanceService)); }, token: PeriodicallyTokenCheckService, providedIn: "root" });
    PeriodicallyTokenCheckService.decorators = [
        { type: i0.Injectable, args: [{ providedIn: 'root' },] }
    ];
    PeriodicallyTokenCheckService.ctorParameters = function () { return [
        { type: ResetAuthDataService },
        { type: FlowHelper },
        { type: ConfigurationProvider },
        { type: FlowsDataService },
    ...
    AuthWellKnownDataService.ctorParameters = function () { return [
        { type: DataService }
    ]; };
    ...
    AuthWellKnownService.ctorParameters = function () { return [
        { type: PublicEventsService },
    ...
    RefreshSessionService.ɵprov = i0.ɵɵdefineInjectable({ factory: function RefreshSessionService_Factory() { return new RefreshSessionService(i0.ɵɵinject(FlowHelper), i0.ɵɵinject(ConfigurationProvider), i0.ɵɵinject(FlowsDataService), i0.ɵɵinject(LoggerService), i0.ɵɵinject(SilentRenewService), i0.ɵɵinject(AuthStateService), i0.ɵɵinject(AuthWellKnownService), i0.ɵɵinject(RefreshSessionIframeService), i0.ɵɵinject(RefreshSessionRefreshTokenService)); }, token: RefreshSessionService, providedIn: "root" });
    RefreshSessionService.decorators = [
        { type: i0.Injectable, args: [{ providedIn: 'root' },] }
    ];
    RefreshSessionService.ctorParameters = function () { return [
        { type: FlowHelper },
        { type: ConfigurationProvider },
        { type: FlowsDataService },
        { type: LoggerService },
        ...
        CheckAuthService.prototype.checkAuth = function (url) {
            ...
            return callback$.pipe(operators.map(function () {
                ...
                if (savedRouteForRedirect) {
                    ...
                    _this.router.navigate([savedRouteForRedirect]);
                }
            }), operators.catchError(function (error) {
    ...
    CheckAuthService.ctorParameters = function () { return [
        { type: undefined, decorators: [{ type: i0.Inject, args: [i1.DOCUMENT,] }] },
    ...
    ConfigValidationService.ctorParameters = function () { return [
        { type: LoggerService }
    ]; };
    ...
    RedirectService.ɵprov = i0.ɵɵdefineInjectable({ factory: function RedirectService_Factory() { return new RedirectService(i0.ɵɵinject(i1.DOCUMENT)); }, token: RedirectService, providedIn: "root" });
    ...
    ResponseTypeValidationService.ctorParameters = function () { return [
        { type: LoggerService },
        { type: FlowHelper }
    ]; };

    var ParService = /** @class */ (function () {
        function ParService(loggerService, urlService, dataService, storagePersistanceService) {
            this.loggerService = loggerService;
            this.urlService = urlService;
            this.dataService = dataService;
            this.storagePersistanceService = storagePersistanceService;
    ...
    ParService.ctorParameters = function () { return [
        { type: LoggerService },
        { type: UrlService },
        { type: DataService },
        { type: StoragePersistanceService }
    ...
    var ParLoginService = /** @class */ (function () {
        ...
        ParLoginService.prototype.loginWithPopUpPar = function (authOptions, popupOptions) {
            ...
            return this.authWellKnownService.getAuthWellKnownEndPoints(authWellknownEndpoint).pipe(operators.switchMap(function () { return _this.parService.postParRequest(customParams); }), operators.switchMap(function (response) {
                ...
                return _this.popupService.receivedUrl$.pipe(operators.take(1), operators.switchMap(function (receivedUrl) { return _this.checkAuthService.checkAuth(receivedUrl); }), operators.map(function (isAuthenticated) { return ({
    ...
    ParLoginService.ctorParameters = function () { return [
        { type: LoggerService },
    ...
    var PopUpLoginService = /** @class */ (function () {
        ...
        PopUpLoginService.prototype.loginWithPopUpStandard = function (authOptions, popupOptions) {
            ...
            return this.authWellKnownService.getAuthWellKnownEndPoints(authWellknownEndpoint).pipe(operators.switchMap(function () {
                ...
                return _this.popupService.receivedUrl$.pipe(operators.take(1), operators.switchMap(function (url) { return _this.checkAuthService.checkAuth(url); }), operators.map(function (isAuthenticated) { return ({
                    isAuthenticated: isAuthenticated,
                    userData: _this.userService.getUserDataFromStore(),
                    accessToken: _this.authStateService.getAccessToken(),
                }); }));
    ...
    PopUpLoginService.ctorParameters = function () { return [
        { type: LoggerService },
        { type: ResponseTypeValidationService },
        { type: UrlService },
        { type: ConfigurationProvider },
    ...
    StandardLoginService.ctorParameters = function () { return [
        { type: LoggerService },
        { type: ResponseTypeValidationService },
        { type: UrlService },
        { type: RedirectService },
    ...
    var LogoffRevocationService = /** @class */ (function () {
        function LogoffRevocationService(dataService, storagePersistanceService, loggerService, urlService, checkSessionService, resetAuthDataService, redirectService) {
            this.dataService = dataService;
            this.storagePersistanceService = storagePersistanceService;
            this.loggerService = loggerService;
            this.urlService = urlService;
    ...
    var AutoLoginGuard = /** @class */ (function () {
        ...
        AutoLoginGuard.prototype.checkAuth = function (url) {
            var _this = this;
            return this.authStateService.authorized$.pipe(operators.concatMap(function (isAuthenticatedAlready) { return (isAuthenticatedAlready ? rxjs.of(isAuthenticatedAlready) : _this.checkAuthService.checkAuth()); }), operators.map(function (isAuthorized) {
                var storedRoute = _this.autoLoginService.getStoredRedirectRoute();
                if (isAuthorized) {
                    if (storedRoute) {
                        _this.autoLoginService.deleteStoredRedirectRoute();
                        _this.router.navigate([storedRoute]);
                    }
                    return true;
                }
    ...
    AutoLoginGuard.ɵprov = i0.ɵɵdefineInjectable({ factory: function AutoLoginGuard_Factory() { return new AutoLoginGuard(i0.ɵɵinject(AutoLoginService), i0.ɵɵinject(AuthStateService), i0.ɵɵinject(CheckAuthService), i0.ɵɵinject(LoginService), i0.ɵɵinject(i5.Router)); }, token: AutoLoginGuard, providedIn: "root" });
    AutoLoginGuard.decorators = [
        { type: i0.Injectable, args: [{ providedIn: 'root' },] }
    ];
    AutoLoginGuard.ctorParameters = function () { return [
        { type: AutoLoginService },
        { type: AuthStateService },
        { type: CheckAuthService },
        { type: LoginService },
    ...
    exports.ɵba = StateValidationService;
    exports.ɵbb = EqualityService;
    exports.ɵbc = RefreshSessionCallbackHandlerService;
    exports.ɵbd = RefreshTokenCallbackHandlerService;
    exports.ɵbe = ImplicitFlowCallbackService;
    exports.ɵbf = IntervallService;
    exports.ɵbg = CallbackService;
    exports.ɵbh = CodeFlowCallbackService;
    exports.ɵbi = RefreshSessionService;
    exports.ɵbj = RefreshSessionIframeService;
    exports.ɵbk = RefreshSessionRefreshTokenService;
    exports.ɵbl = PeriodicallyTokenCheckService;
    exports.ɵbm = PopUpService;
    exports.ɵbn = AutoLoginService;
    exports.ɵbo = LogoffRevocationService;
    exports.ɵbp = RedirectService;
    exports.ɵbq = LoginService;
    exports.ɵbr = ParLoginService;
    exports.ɵbs = ResponseTypeValidationService;
    exports.ɵbt = ParService;
    exports.ɵbu = PopUpLoginService;
    exports.ɵbv = StandardLoginService;
    exports.ɵbw = BrowserStorageService;
    exports.ɵc = AuthWellKnownService;
    exports.ɵd = AuthWellKnownDataService;
    exports.ɵe = DataService;
    exports.ɵf = HttpBaseService;
    exports.ɵg = StoragePersistanceService;
    exports.ɵh = ConfigValidationService;
    exports.ɵi = FlowHelper;
    exports.ɵj = CheckSessionService;
    exports.ɵk = IFrameService;
    exports.ɵl = CheckAuthService;
    exports.ɵm = SilentRenewService;
    exports.ɵn = FlowsService;
    exports.ɵo = CodeFlowCallbackHandlerService;
    exports.ɵp = UrlService;
    exports.ɵq = FlowsDataService;
    exports.ɵr = RandomService;
    exports.ɵs = ImplicitFlowCallbackHandlerService;
    exports.ɵt = ResetAuthDataService;
    exports.ɵu = AuthStateService;
    exports.ɵv = UserService;
    exports.ɵw = HistoryJwtKeysCallbackHandlerService;
    exports.ɵx = SigninKeyDataService;
    exports.ɵy = UserCallbackHandlerService;
    exports.ɵz = StateValidationCallbackHandlerService;
