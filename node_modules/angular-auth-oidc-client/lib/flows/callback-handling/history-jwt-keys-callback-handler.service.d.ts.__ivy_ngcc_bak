...
export declare class HistoryJwtKeysCallbackHandlerService {
    ...
    constructor(loggerService: LoggerService, configurationProvider: ConfigurationProvider, authStateService: AuthStateService, flowsDataService: FlowsDataService, signInKeyDataService: SigninKeyDataService, storagePersistanceService: StoragePersistanceService, resetAuthDataService: ResetAuthDataService);
