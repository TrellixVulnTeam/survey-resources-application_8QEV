...
*/
import{glsl as e}from"../../../core/shaderModules/interfaces.js";import{VertexPosition as o}from"../../../core/shaderLibrary/attributes/VertexPosition.glsl.js";import{IsNaN as t}from"../../../core/shaderLibrary/util/IsNaN.glsl.js";function r(r,a){r.vertex.include(t),r.include(o,a);const s=r.vertex;s.uniforms.add("uDepthBias","vec2"),s.uniforms.add("uViewportDimInv","vec2"),a.legacy?(s.uniforms.add("uView","mat4"),s.uniforms.add("uProj","mat4")):s.uniforms.add("uTransformNormal_ViewFromGlobal","mat3"),a.legacy?s.code.add(e`
  ...
  `)}export{r as AdjustProjectedPosition};
