...
*/
import{glsl as e}from"../../shaderModules/interfaces.js";import{PositionAttribute as o}from"./PositionAttribute.glsl.js";function r(r,i){r.attributes.add("featureValue","vec4"),r.vertex.code.add(e`
  bool isCapVertex() {
    return featureValue.w == 1.0;
  }
  `),r.vertex.uniforms.add("size","vec3"),i.vvSize?(r.vertex.uniforms.add("vvSizeMinSize","vec3"),r.vertex.uniforms.add("vvSizeMaxSize","vec3"),r.vertex.uniforms.add("vvSizeOffset","vec3"),r.vertex.uniforms.add("vvSizeFactor","vec3"),r.vertex.code.add(e`
    vec2 getSize() {
    ...
    `),i.vvOpacity?(r.vertex.constants.add("vvOpacityNumber","int",8),r.vertex.code.add(e`
    ...
    `),i.vvColor?(r.vertex.constants.add("vvColorNumber","int",8),r.vertex.code.add(e`
    ...
    `),r.include(o),r.attributes.add("profileRight","vec4"),r.attributes.add("profileUp","vec4"),r.attributes.add("profileVertexAndNormal","vec4"),r.vertex.code.add(e`
  vec3 calculateVPos() {
    vec2 size = getSize();
